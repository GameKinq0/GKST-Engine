...
# --- OPERATÖRLER ---
# ... [Önceki Manuel Operatörler (OriginToBottom, PurgeData, SplitMesh vb.) AYNI KALACAK] ...
    ...
    def execute(self, context):
        ...
        for obj in context.selected_objects:
            if obj.type == 'MESH':
                ...
                exporter.execute_export(export_mesh=False, export_textures=True)
        self.report({'INFO'}, "GKST: Texture'lar başarıyla klasöre çıkarıldı.")
        return {'FINISHED'}
...
class GKST_OT_MasterExecute(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        context.window_manager.progress_begin(0, len(context.selected_objects))
        ...
        for i, obj in enumerate(context.selected_objects):
            ...
            if scene.gkst_target_engine == 'ROBLOX' and scene.gkst_auto_split:
                ...
                if len(obj.data.loop_triangles) > 9500:
                    ...
                    # Parçalara ayrıldığı için döngüyü yeniden tasarlamak gerekebilir ama basit tuttuk.
...
# Eski araçları ve yenilerini kaydetmeyi unutma!
# ... (Eski sınıfların buraya yapıştırılacak)
...
classes = (
    ...
    GKST_OT_ExtractTextures, # Yeni
    GKST_OT_MasterExecute # Yeni
)
